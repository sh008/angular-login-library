...
class LoginLibComponent {
    ...
    submit() {
        ...
        //set send data
        let data = {};
        data[this.options.usernameBindName] = (_a = this.form.get('username')) === null || _a === void 0 ? void 0 : _a.value;
        data[this.options.passwordBindName] = (_b = this.form.get('username')) === null || _b === void 0 ? void 0 : _b.value;
        (_c = this.$loginApi(data)) === null || _c === void 0 ? void 0 : _c.subscribe({
            next: (res) => {
                this.submitSpinner = false;
    ...
    tokenHandler(token) {
        var _a;
        const storage = ((_a = this.form.get('rememberMe')) === null || _a === void 0 ? void 0 : _a.value)
            ? localStorage
            : sessionStorage;
